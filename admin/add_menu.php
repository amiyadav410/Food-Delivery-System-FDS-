                ...
                <body class="fix-header">
                    ...
                    <div id="main-wrapper">
                        ...
                        <div class="page-wrapper">
                            ...
                            <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> The dashboard provides a comprehensive overview of real-time data, including order statuses, restaurant activity, order activity and user engagement metrics.</marquee>
                            </div>
