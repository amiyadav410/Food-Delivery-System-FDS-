                ...
                <body class="fix-header">
                    ...
                    <div id="main-wrapper">
                        ...
                        <div class="page-wrapper">
                            ...
                            <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> The dashboard provides a comprehensive overview of real-time data, including order status, restaurant activity, order activity and user engagement metrics.</marquee>
                            </div>
                                                    ...
                                                    <div class="row p-t-20">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="d_name" value="<?php echo $roww['title'];?>" class="form-control" placeholder="Enter Dish Name">
                                                            </div>
                                                        </div>
